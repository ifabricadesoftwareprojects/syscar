    ...
    <div class="row">
      <div class="col-md-9 col-md-push-3">
        ...
        <div class="row">
          ...
          <div class="col-md-4 grid_listing">
            <div class="product-listing-m gray-bg">
              <div class="product-listing-img"> <a href="#"><img src="<?php echo link_assets('site/images/featured-img-2.jpg') ?>" class="img-responsive" alt="image" /> </a>
          ...
          <div class="col-md-4 grid_listing">
            <div class="product-listing-m gray-bg">
              <div class="product-listing-img"> <a href="#"><img src="<?php echo link_assets('site/images/featured-img-3.jpg') ?>" class="img-responsive" alt="image" /> </a>
                <div class="label_icon">New</div>
                <div class="compare_item">
                  <div class="checkbox">
      ...
      <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="#"><img src="<?php echo link_assets('site/images/post_200x200_1.jpg') ?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="#">Ford Shelby GT350</a>
                  <p class="widget_price">$92,000</p>
                </div>
              </li>
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="#"><img src="<?php echo link_assets('site/images/post_200x200_2.jpg') ?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="#">BMW 535i</a>
                  <p class="widget_price">$92,000</p>
                </div>
              </li>
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="#"><img src="<?php echo link_assets('site/images/post_200x200_3.jpg') ?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="#">Mazda CX-5 SX, V6, ABS, Sunroof </a>
                  <p class="widget_price">$92,000</p>
                </div>
              </li>
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="#"><img src="<?php echo link_assets('site/images/post_200x200_4.jpg') ?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="#">Ford Shelby GT350 </a>
                  <p class="widget_price">$92,000</p>
                </div>
              </li>
  ...
  <div class="container">
    ...
    <div class="brand-logo-list">
      <div id="popular_brands">
        <div><a href="#"><img src="<?php echo link_assets('site/images/brand-logo-1.png') ?>" class="img-responsive" alt="image"></a></div>
        <div><a href="#"><img src="<?php echo link_assets('site/images/brand-logo-2.png') ?>" class="img-responsive" alt="image"></a></div>
        <div><a href="#"><img src="<?php echo link_assets('site/images/brand-logo-3.png') ?>" class="img-responsive" alt="image"></a></div>
        <div><a href="#"><img src="<?php echo link_assets('site/images/brand-logo-4.png') ?>" class="img-responsive" alt="image"></a></div>
        <div><a href="#"><img src="<?php echo link_assets('site/images/brand-logo-5.png') ?>" class="img-responsive" alt="image"></a></div>
      </div>
    </div>
  </div>
</section>
