                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" name="email" class="form-control" placeholder="fulano@syscar.com" value="<?php echo $usuario->email ?>"<?php echo (isset($dados_usuario) ? $dados_usuario['email'] : '') ?>>
